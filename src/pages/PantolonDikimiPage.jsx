        ...
        <div className="container-width section-padding">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-4">
              ...
              <div className="mb-8">
                <img
                  src="https://images.unsplash.com/photo-1583394838336-acd977736f90?w=800&h=400&fit=crop&q=80"
                  alt="Pantolon Dikimi Tesisi"
              ...
              {/* Section Title */}
              <h2 className="text-2xl font-bold text-gray-800 mb-6">Pantolon Dikimi</h2>
            ...
            <div className="lg:col-span-1">
              ...
              <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="border-b border-gray-200 pb-2">
                    <span className="text-orange-600 font-semibold">Pantolon Dikimi</span>
                  </div>
                  <div className="border-b border-gray-200 pb-2">
                    <Link 
                      to="/mont-dikimi" 
...
export default PantolonDikimiPage
